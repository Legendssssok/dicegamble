...
class CryptoPayments:
    ...
    def createHmac(self, **params):
        ...
        return (
            encoded,
            hmac.new(
                bytearray(self.privateKey, "utf-8"), encoded, hashlib.sha512
            ).hexdigest(),
        )
    ...
    def Request(self, request_method, **params):
        ...
        try:
            ...
            response_body_decoded.update(
                response_body_decoded["result"]
            )  # clean up dictionary, flatten "result" key:value pairs to parent dictionary
        ...
        params.update(
            {
                ...
                "buyer_email": "kkjaiswal0987@gmail.com",
                "format": self.format,
            }
        )
