...
**{user.first_name}** , your turn! To start, send a dice emoji: 🎲""",
        ...
        left_balance_player1 = players_balance[player1.id] - float(
            bet_amount_in_ltc
    ...
    if gamemode == "botwplayers":
        ...
        if round == current_round:
            ...
            if score_player1 > score_player2:
                ...
                add_balance = players_balance[user.id] + float(win_amount_in_ltc)
                ...
                add_balance = players_balance[my_bot.id] + float(win_amount_in_ltc)
        ...
        if count_round.get(player2.id, 1) % 2 == 0:
            ...
            if round + round == current_round:
                ...
                if score_player1 > score_player2:
                    ...
                    add_balance = players_balance[player2.id] + float(win_amount_in_ltc)
...
**Expire In :** {int(hours)}:{int(minutes)}:{int(seconds)}""",
                ...
                add_players_balance(
                    query_user_id, float(old_balance) + float(net_fund)
                )  # add balance in ltc
                await event.reply(
